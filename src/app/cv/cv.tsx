                ...
                <div className="scene">
                    <div className="cube">
                        <div className=" cube-part front overflow-hidden">
                            <img src="/IMG_3649.JPG" alt="principle photo" className="photo object-cover w-full h-full pointer-events-none scale-110"/>
                        </div>
                        <div className="cube-part back overflow-hidden">
                            <img src="/cuisinier.jpg" alt="cuisinier photo" className="photo object-cover w-full h-full pointer-events-none scale-150"/>
                        </div>
